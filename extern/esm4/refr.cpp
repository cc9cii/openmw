...
ESM4::Reference::Reference() : mFormId(0), mFlags(0), mBaseObj(0), mScale(1.f), mOwner(0), mGlobal(0),
                               mFactionRank(0), mInitiallyDisabled(false), mIsMapMarker(false), mMapMarker(0),
                               mCount(1), mAudioLocation(0)
{
    mEditorId.clear();
    mFullName.clear();
